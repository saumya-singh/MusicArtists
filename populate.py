...
cur.execute('''CREATE TABLE IF NOT EXISTS RELEASES
      ...
      SONG_ID   CHAR(50)  REFERENCES SONGS(ID),
      NAME           TEXT          NOT NULL);''')
...
for row in spamReader:
    ...
    query1 = "INSERT INTO ARTISTS (ID,NAME,POPULARITY,LATITUDE,LONGITUDE) \
              VALUES (\'{0}\', \'{1}\', \'{2}\', \'{3}\', \'{4}\')".format(
              details[1], details[2], details[0], details[3], details[4])
    query3 = "INSERT INTO SONGS (ID,TITLE,TEMPO,TERMS,YEAR) \
              VALUES (\'{0}\', \'{1}\', \'{2}\', \'{3}\', \'{4}\')".format(
              details[7], details[10], details[8], details[9], details[11])
...
for row in spamReader:
    raw_details = row[0].split(",")
    details = clean_code(raw_details)
    query2 = "INSERT INTO RELEASES (ID,NAME,ARTIST_ID,SONG_ID) \
              VALUES (\'{0}\', \'{1}\', \'{2}\', \'{3}\')".format(
              details[5], details[6], details[1], details[7])
